...
interpreter = tf.lite.Interpreter(model_path='models/pisang_detector.tflite')
...
class_names = ['cordana', 'healthy', 'pestaloptiopsis', 'sigatoka']

# Load dan preprocess gambar
img_path = 'test_real/pestaloptiopsis.jpeg'
